...
function calculateNewQuota(currentQuota: number, daysRequested: number, action: 'DEDUCT' | 'TOP_UP', topUpDays = 0): number {
  if (action === 'DEDUCT') {
...
describe('Leave Quota & HR Top-Up Logic (TypeScript)', () => {
