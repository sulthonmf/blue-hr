...
describe('Geofencing & Distance Calculations', () => {
  ...
  const officeLng = 106.8456; // Jakarta central coords
  ...
  it('should allow check-in when user is within 5.0 km radius', () => {
    // Coordinate ~1.5 km away from Jakarta central
  ...
  it('should REJECT check-in when user is > 5.0 km radius (e.g. 15 km away in Depok/Bogor)', () => {
    // Coordinate ~20 km away
