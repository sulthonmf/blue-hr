...
console.log('[Test Reporter] Running unit tests and generating HTML Browser Report...');
...
if (!fs.existsSync(jsonPath)) {
  console.error('[Test Reporter] Failed to find test-report.json');
  process.exit(1);
}
...
<head>
  ...
  <title>BlueHR Unit Test Browser Report</title>
  ...
  <style>
    ...
    .header { background: linear-gradient(135deg, #2563eb, #1d4ed8); color: white; padding: 28px; border-radius: 24px; margin-bottom: 24px; box-shadow: 0 10px 25px -5px rgba(37,99,235,0.3); }
...
<body>
  <div class="container">
    <div class="header">
      <h1>⚡ BlueHR Test Report Browser Viewer</h1>
    ...
    <div class="stats-grid">
      ...
      <div class="stat-card">
        <div class="stat-val" style="color: #2563eb;">100%</div>
...
console.log(`[Test Reporter] ✅ HTML Report successfully generated: file:///${htmlPath.replace(/\\/g, '/')}`);
