...
> = ({ isOpen, onClose, initialAnnouncement }) => {
        ...
        >
          ...
          >
            ...
            <View
              style={[
                styles.activeCard,
                isDark ? styles.activeCardDark : styles.activeCardLight,
              ]}
            >
              ...
              <Text style={styles.metaText}>
                Oleh {activeAnn.author_name || "Tim HR"} •{" "}
                {activeAnn.created_at || "Hari ini"}
              </Text>
              ...
              <Text
                style={[
                  styles.annBody,
                  isDark ? styles.textBodyDark : styles.textBodyLight,
                ]}
              >
                {activeAnn.content}
              </Text>
...
const styles = StyleSheet.create({
  ...
  card: { borderRadius: 5, padding: 20, maxHeight: "85%" },
  cardDark: {
