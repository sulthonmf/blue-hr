              ...
              notifications.map((item) => (
                ...
                >
                  <View style={styles.iconBox}>
                    <Feather
                      name={item.type === 'LEAVE' ? 'calendar' : item.type === 'ATTENDANCE' ? 'clock' : 'bell'}
                      size={16}
                      color="#2563eb"
                    />
                  </View>
                  <View style={{ flex: 1 }}>
                    <Text style={[styles.notifTitle, isDark ? styles.textDark : styles.textLight]}>
                      {item.title}
                    </Text>
...
const styles = StyleSheet.create({
  ...
  card: { padding: 20, borderRadius: 28, maxHeight: 420 },
  cardDark: { backgroundColor: '#0f172a', borderColor: '#1e293b', borderWidth: 1 },
  cardLight: { backgroundColor: '#ffffff' },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14, borderBottomWidth: 1, borderBottomColor: '#334155', paddingBottom: 10 },
  ...
  emptyText: { textAlign: 'center', color: '#94a3b8', fontSize: 12, marginVertical: 30 },
  notifItem: { flexDirection: 'row', gap: 10, padding: 12, borderRadius: 16, marginBottom: 8, borderWidth: 1 },
  unreadDark: { backgroundColor: 'rgba(37, 99, 235, 0.15)', borderColor: '#2563eb' },
  unreadLight: { backgroundColor: '#eff6ff', borderColor: '#bfdbfe' },
  readDark: { backgroundColor: '#1e293b', borderColor: '#334155', opacity: 0.7 },
  readLight: { backgroundColor: '#f8fafc', borderColor: '#e2e8f0', opacity: 0.7 },
  iconBox: { width: 32, height: 32, borderRadius: 16, backgroundColor: 'rgba(37, 99, 235, 0.15)', justifyContent: 'center', alignItems: 'center' },
