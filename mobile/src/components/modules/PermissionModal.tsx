        ...
        >
          <View style={styles.header}>
            ...
            <Text style={styles.desc}>
              Untuk memastikan validitas presensi, aplikasi memerlukan izin
              akses Kamera (Foto Selfie Presensi) dan Lokasi GPS Perangkat.
            </Text>
          </View>
            ...
            <View style={styles.permRow}>
              ...
              <View>
                ...
                <Text style={styles.permDesc}>
                  Memverifikasi posisi Anda dalam radius lokasi kantor
                </Text>
              </View>
            </View>
            <View style={styles.permRow}>
              ...
              <View>
                ...
                <Text style={styles.permDesc}>
                  Mengambil foto selfie verifikasi saat presensi
                </Text>
              </View>
            </View>
          </View>
