...
export const AnnouncementsScreen: React.FC = () => {
      ...
      setAnnouncements([
        {
          ...
          content:
            "Seluruh karyawan diwajibkan melakukan absen geofencing radius 5 km dari lokasi kantor.",
          category: "IMPORTANT",
          created_at: "2026-08-20",
        },
        {
          id: 2,
          title: "Townhall All-Hands Meeting Q3",
          content:
            "Acara Townhall perusahaan akan diselenggarakan hari Jumat jam 14.00 WIB.",
          category: "GENERAL",
  ...
  return (
    ...
    >
      ...
      >
        {t.announcements || "Pengumuman Perusahaan"}
      </Text>
