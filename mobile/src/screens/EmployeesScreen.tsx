...
export const EmployeesScreen: React.FC = () => {
  ...
  const departments = [
    "ALL",
    ...Array.from(new Set(empList.map((e) => e?.department).filter(Boolean))),
  ];
...
const styles = StyleSheet.create({
  ...
  empCard: { padding: 14, borderRadius: 50, borderWidth: 1 },
