...
export const LeaveScreen: React.FC<{ onOpenLeaveModal: () => void }> = ({
  onOpenLeaveModal,
}) => {
  ...
  return (
    ...
    >
      {/* Quota Card */}
      <View
        style={[styles.quotaCard, isDark ? styles.cardDark : styles.cardLight]}
      >
        <View style={styles.quotaRow}>
          <View>
            ...
            >
              {user?.leave_quota ?? 12}{" "}
              <Text style={{ fontSize: 14, color: "#94a3b8" }}>Hari</Text>
            </Text>
          </View>
          <TouchableOpacity
          ...
          >
            ...
            <View style={styles.dateRow}>
              <Text style={styles.dateText}>
                {item.start_date} s/d {item.end_date} ({item.duration_days}{" "}
                Hari)
              </Text>
            </View>
          </View>
