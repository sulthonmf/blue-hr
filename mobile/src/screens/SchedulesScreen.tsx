  ...
  const fetchData = async () => {
    try {
      ...
      setRooms([
        {
          id: 1,
          name: "Ruang Rapat Utama (Executive)",
          capacity: 16,
          location: "Lantai 3 - Gedung A",
        },
        {
          id: 2,
          name: "Ruang Diskusi Alpha",
          capacity: 8,
  ...
  return (
    ...
    >
      <View style={styles.headerRow}>
        ...
        >
          {t.schedules || "Agenda & Ruang Rapat"}
        </Text>
        <TouchableOpacity
          style={styles.addBtn}
        ...
        >
          <Text style={styles.addBtnText}>
            {isBooking ? t.cancel : "+ Pesan Ruangan"}
          </Text>
        </TouchableOpacity>
      </View>
      ...
      {isBooking && (
        ...
        >
          ...
          <TextInput
            ...
            placeholder="Sprint Sync / Meeting Klien..."
          ...
          {rooms.map((r) => (
            <TouchableOpacity
              ...
              style={[
                styles.roomPill,
                isDark ? styles.roomPillDark : styles.roomPillLight,
                selectedRoom === r.id && styles.roomPillActive,
              ]}
            >
              <Text
                style={[
                  styles.roomPillText,
                  isDark ? styles.textDark : styles.textLight,
                  selectedRoom === r.id && styles.textWhite,
                ]}
              >
      ...
      {schedules.map((s) => (
        ...
        >
          ...
          <Text style={styles.schedRoom}>
            {s.room_name || "Virtual Meeting"}
          </Text>
          <Text style={styles.schedTime}>
            {s.date} • {s.start_time} - {s.end_time} WIB
          </Text>
          {s.meeting_link && (
            <Text style={styles.linkText}>🔗 {s.meeting_link}</Text>
          )}
        </View>
      ))}
    </ScrollView>
